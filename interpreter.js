var $$ = (function (memory, robot) {
    ...
    /*
     ...
     PUSH                   i (i=0,Е,127) Ц помещает в регистр 0 значение i.
     X2                     128 Ц увеличивает значение в регистре r0 в два раза.
     SET_R0$RI              128+i (i=1,Е,7) Ц помещает в регистр r0 значение из регистра ri
     INC                    136 Ц увеличивает значение в регистре r0 на 1.
     SET_RI$R0              136+i (i=1,Е,7) Ц помещает в регистр ri значение из регистра r0.
     SET_R0$MEM_RI          144+i (i=0,Е,7) Ц помещает в регистр r0 значение из «” по адресу, хран€щемус€ в регистре ri.
     SET_MEM_RI$R0          152+i (i=0,Е,7) Ц помещает в «” по адресу, хран€щемус€ в регистре ri, значение из регистра r0.
     LOGIC_1                160+i (i=0,Е,7) r0=(r0+ri)%256.
     LOGIC_2                168+i (i=0,Е,7) r0=(r0-ri+256)%256.
     LOGIC_3                176+i (i=0,Е,7) r0=(r0*ri)%256.
     LOGIC_4                184+i (i=0,Е,7) r0=(r0/ri)%256.
     MOVE_R0_RI_LESS_RJ     192+i*8+j (i=1,Е,7; j=1,Е,7; i?j)  Ц переходит по адресу в регистре r0, если ri<rj (как беззнаковые числа)
     DEC                    192 Ц уменьшает значение в регистре r0 на 1.
     MOVE_RI                192+i*8+i (i=1,Е,7) Ц переходит по адресу в регистре ri.
     SWAP_R0$RI             192+i (i=1,Е,7) Ц мен€ет местами значени€ в регистрах r0 и ri
     SWAP_R0$MEM_RI         192+i*8 (i=1,Е,7) Ц мен€ет местами значени€ в регистре r0 €чейки, адрес которой хранитс€ в регистре ri.
